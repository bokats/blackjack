...
and current hands. All the buttons for the game will be outside of the game board
...
1) board.js: Holds the information needed to be rendered in the html
...
**Day 2**: Learn how to render the information in html without using React. Goals of the day:

  - Set up 'board.js' file to render the appropriate information to the html
  - Set up buttons for the game
  - There should be a functional game with minimal styling

**Day 3**: Style the game board and buttons. Game should look good and be fully functional. Goals of the day:
